    ...
    <div class="container mx-auto pt-8 pb-4 ">
        ...
        <div class="flex flex-wrap overflow-hidden sm:text-center sm:-mx-1 md:-mx-px lg:-mx-2 xl:-mx-2">
            ...
            <div class="w-full overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-px md:px-px md:w-1/2 lg:my-2 lg:px-2 lg:w-1/4 xl:my-2 xl:px-2 xl:w-1/4 pb-6">
                ...
                <ul class="nav navbar-nav">
                    <li id="navi-2" class="leading-7 text-sm">
                        <a class="text-white underline text-small no-underline" href="<?php echo e(route('blog.index')); ?>">
                            Blogs</a>
                    </li>
            ...
            <div class="w-full overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-px md:px-px md:w-1/2 lg:my-2 lg:px-2 lg:w-1/4 xl:my-2 xl:px-2 xl:w-1/4 pb-6">
                ...
                <li id="navi-1" class="leading-7 text-sm"><a class="text-white underline text-small no-underline" href="<?php echo e(route('blog.create')); ?>">Create</a></li>
                </ul>
            </div>
            ...
            <div class="w-full overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-px md:px-px md:w-1/2 lg:my-2 lg:px-2 lg:w-1/4 xl:my-2 xl:px-2 xl:w-1/4 pb-6">
                ...
                <li id="navi-1" class="leading-7 text-sm"><a class="text-white underline text-small no-underline" href="<?php echo e(route('feedbackform')); ?>">Feedback</a></li>
                </ul>
            </div>
        ...
        <div class="pt-4 md:flex md:items-center md:justify-center " style="border-top:1px solid white">
            <ul class="">
                ...
                <li class="md:mx-2 md:inline leading-7 text-sm" id="footer-navi-2"><a class="text-white underline text-small" href="<?php echo e(route('aboutandprivacypage')); ?>">Privacy</a></li>
                </ul>
            </div>
...
</nav><?php /**PATH C:\xampp\htdocs\blogprototype\resources\views/layouts/footer.blade.php ENDPATH**/ ?>