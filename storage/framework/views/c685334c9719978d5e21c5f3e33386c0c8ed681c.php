        ...
        <div class="px-4 pt-4">
          <form action="#" class="flex flex-col space-y-8">
            ...
            <div class="form-item">
              ...
              <input type="text" value="" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mt-1 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" >
            </div>
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
              ...
              <div class="form-item w-full">
                ...
                <input type="text" value="" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mt-1 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25 " >
              </div>
            ...
            <div>
              <h3 class="text-2xl font-semibold pb-1">More About Me</h3>
              <hr>
            </div>
  
            <div class="form-item w-full">
              <label class="text-xl ">Biography</label>
              <textarea cols="30" rows="10" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 mt-2 focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25 " ></textarea>
            </div>
  
            <div>
              <h3 class="text-2xl font-semibold pb-1">My Social Media</h3>
              <hr>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blogprototype\resources\views/profiles/profile_create.blade.php ENDPATH**/ ?>