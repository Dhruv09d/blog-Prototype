...
<div class="w-full relative my-0 shadow-2xl rounded overflow-hidden">
    <div class="top h-64 w-full bg-blue-600 overflow-hidden relative" >
      ...
      <div class="flex flex-col justify-center items-center relative h-full bg-black bg-opacity-50 text-white">
        <img src="<?php echo e(asset('/defaultAvatar/avatar-1299805_640.png')); ?>" class="h-28 w-28 object-cover rounded-full">
        <h1 class="text-2xl font-semibold mb-2"><?php echo e($loggedin_user->name); ?></h1>
        <h4 class="text-sm font-semibold">Joined Since '<?php echo e(date('y', strtotime($loggedin_user->updated_at))); ?></h4>
      </div>
    </div>
