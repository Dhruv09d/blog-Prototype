        ...
        <div class="mt-5 overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <form action="/blog/<?php echo e($slug); ?>/delete" method="POST" class="p-6 flex flex-col justify-center">
                    ...
                    <a href="<?php echo e(route('blog.index')); ?>" class=" w-3/12 text-center justify-center bg-indigo-600 hover:bg-blue-dark text-white font-bold py-3 px-2 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300">
