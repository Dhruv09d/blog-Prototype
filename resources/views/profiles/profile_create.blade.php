        ...
        <div class="px-4 pt-4">
          ...
          <div id="nameE" style="display:block;">
            ...
            <div class="form-item mt-3">
              ...
              <input type="text" value="{{ $loggedin_user->name}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mt-1 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" >
            </div>

            <div class="form-item mt-3">
              <label class="text-xl w-full">Email</label>
              <input type="text" value="{{ $loggedin_user->email}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mt-1 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25 " >
            </div>
