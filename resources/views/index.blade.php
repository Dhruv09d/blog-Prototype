...
@section('content')
    ...
    <div class="sm:grid grid-cols-2 w-4/5 m-auto py-5 border-b bg-pink-200 ">
        ...
        <div class="align-middle mx-auto bg-pink-200 mb-10">
            <img src="{{asset('/staticImg/madara.png')}}" alt="image" width="600" title="Madara Uchiha">
        </div>
        {{-- 2 --}}
        <div class="align-middle mx-auto bg-pink-200 mt-10">
            <img src="{{ asset('/staticImg/kakashi.png')}}" alt="image" width="500" title="kakashi hatake">
        </div>
